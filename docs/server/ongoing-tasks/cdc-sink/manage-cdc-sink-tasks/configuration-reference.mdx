---
title: "CDC Sink: Configuration Syntax"
...
the join column values. See [REPLICA IDENTITY](../../../../server/ongoing-tasks/cdc-sink/source-database-setup/postgres/replica-identity.mdx).
</Admonition>
