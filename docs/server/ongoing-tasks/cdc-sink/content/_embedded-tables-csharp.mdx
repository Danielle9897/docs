...
{
    SourceTableSchema = "public",         // Source schema (default: "public" PostgreSQL, "dbo" SQL Server, db name for MySQL)
...
**PostgreSQL:** See [REPLICA IDENTITY](../../../../server/ongoing-tasks/cdc-sink/source-database-setup/postgres/replica-identity.mdx)
...
See [Delete Strategies](../../../../server/ongoing-tasks/cdc-sink/delete-strategies.mdx).
