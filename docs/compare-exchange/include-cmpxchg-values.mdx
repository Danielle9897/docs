---
title: "Include comparee-exchange values"
hide_table_of_contents: true
sidebar_label: "Include comparee-exchange values"
sidebar_position: 8
---
...
(Note: Need to refactor the C# article according to the Node.js one.)
...
| - | - | - |
| **path** | `string`; `Expression<Func<T, string>>`; `Expression<Func<T, IEnumerable<string>>>` | The key of the compare exchange value you want to include, a path to the key, or a path to a `string[]` of keys. |
...
| Parameter | Type | Description |
| - | - | - |
| **key** | `string`; path to `string` | The key of the compare exchange value you want to include, or a path to the key. |
