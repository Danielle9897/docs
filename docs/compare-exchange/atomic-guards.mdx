...
* **Atomic Guards** are [compare-exchange key/value items](../compare-exchange/overview.mdx)
  that RavenDB creates and manages **automatically** to guarantee [ACID](../server/clustering/cluster-transactions.mdx#cluster-transaction-properties) transactions in cluster-wide sessions.  
