---
title: "Create items from the Client API"
hide_table_of_contents: true
sidebar_label: "Create items from the Client API"
sidebar_position: 0
---
...
# Create compare-exchange items via the Client API
...
* In this article:  
  ...
  * [Create items via a store operation](../todo..)  
    * [Example I - Create a new key](../compare-exchange/put-compare-exchange-value.mdx#example-i---create-a-new-key)  
    * [Example II - Update an existing key](../compare-exchange/put-compare-exchange-value.mdx#example-ii---update-an-existing-key)  
    * [Example III - Try to create an item with a non-zero index](../compare-exchange/put-compare-exchange-value.mdx#example-iii---try-to-create-an-item-with-a-non-zero-index)
    * [Example IV - Create with metadata](../todo..)
    * [Syntax](../compare-exchange/put-compare-exchange-value.mdx#syntax)   
  
  * [Create items via Cluster-Wide session](../compare-exchange/manage-compare-exchange/create-compare-exchange-Item/create-cmpxchg-items-from-the-client-api#create-via-cluster-wide-session)
    * [Example](../todo..)   
    * [Syntax](../compare-exchange/put-compare-exchange-value.mdx#syntax)   
...
* For an overview of the 'compare-exchange' feature see: [Compare Exchange Overview](../todo..).
...
| ------------ | - | - |
| **Successful** | `bool` | * _True_ if the save operation has completed successfully * _False_ if the save operation failed |
| **Value** | `T` | * The value that was saved if operation was successful * The currently existing value in the server upon failure |
...
## Create items via Cluster-Wide session
