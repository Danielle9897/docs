...
* **Document Store Operations**  
  ...
  For example, see [Create items via a store operation](../compare-exchange/create-cmpxchg-items#create-items-via-a-store-operation).
...
* **Cluster-Wide Sessions**  
  ...
  For example, see [Create items via a cluster-wide session](../compare-exchange/create-cmpxchg-items#create-items-via-a-cluster-wide-session).     
...
* When creating a compare-exchange item, a Raft consensus is required from the nodes in the database group.
  Externally replicating such data is problematic since the target database may reside within a cluster that is in an
...
* This compare-exchange item was [created as an operation](../compare-exchange/create-cmpxchg-items#create-items-via-a-store-operation)
  rather than with a [cluster-wide session](../compare-exchange/create-cmpxchg-items#create-items-via-a-cluster-wide-session).  
