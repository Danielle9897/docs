...
* In this page:
    ...
    * [Dynamic-index-fields view](../indexes/using-dynamic-fields#dynamic-index-fields-view)
...
{PANEL: Dynamic-index-fields view}

The generated dynamic-index-fields can be viewed in the Studio under the __Terms View__.
Todo.. Add image...
