...
* To define a **vector index-field** in your static-index definition:  
  ...
  * From the Studio - see [Define a vector field in the Studio](../../ai-integration/vector-search/vector-search-using-static-index#define-a-vector-field-in-the-studio).  

* The **source data types** that can be used for vector search is detailed in [Data types for vector search](../../ai-integration/vector-search/data-types-for-vector-search).
