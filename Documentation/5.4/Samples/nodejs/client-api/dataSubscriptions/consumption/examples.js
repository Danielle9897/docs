...

    {
        ...
        async function setupReconnectingWorker(subscriptionName) {
            ...
            function closeWorker(worker) {
                ...
                // After this, I never get back to the reconnect code
            }
            ...
            function reconnect() {
                ...
                subscriptionWorker = documentStore.subscriptions.getSubscriptionWorker(
                    { subscriptionName: subscriptionName });
                ...
                subscriptionWorker.on("error", error => {
                    ...
                    return reconnect(); // reconnect or just closeWorker here ?
                });
